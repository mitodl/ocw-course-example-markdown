---
uid: 14fc866ff60fc69f19eb4338bbc87675
title: Assignments
...
| --- | --- | --- | --- |
| 0 | Vectors | None | None |
| {{< td-colspan 4 >}}**Week 1: Kinematics**{{< /td-colspan >}} ||||
| 1 | 1D Kinematics - Position and Velocity | [Problem Set 1 (PDF)]({{< baseurl >}}/sections/assignments/mit8_01f16_pset1_new) |  {{< br >}}{{< br >}} [Derivatives in Kinematics]({{< baseurl >}}/sections/week-1-kinematics/1.7-worked-example-derivatives-in-kinematics) {{< br >}}{{< br >}} [Acceleration from Position]({{< baseurl >}}/sections/week-1-kinematics/2.3-worked-example-acceleration-from-position) {{< br >}}{{< br >}} [Shooting the Apple]({{< baseurl >}}/sections/week-1-kinematics/ps.1.2-shooting-the-apple) {{< br >}}{{< br >}} [Braking Car]({{< baseurl >}}/sections/week-1-kinematics/ps.1.3-worked-example-braking-car) {{< br >}}{{< br >}} [Sketch the Motion]({{< baseurl >}}/sections/week-1-kinematics/ps.1.4-sketch-the-motion) {{< br >}}{{< br >}} [Pedestrian and Bike at Intersection]({{< baseurl >}}/sections/week-1-kinematics/ps.1.5-worked-example-pedestrian-and-bike-at-intersection) {{< br >}}{{< br >}}  |
| 2 | 1D Kinematics - Acceleration |
| 3 | 2D Kinematics - Position, Velocity, and Acceleration |
| {{< td-colspan 4 >}}**Week 2: Newton's Laws**{{< /td-colspan >}} ||||
| 4 | Newton's Laws of Motion | [Problem Set 2 (PDF)]({{< baseurl >}}/sections/assignments/mit8_01f16_pset2) |  {{< br >}}{{< br >}} [Gravity Superposition]({{< baseurl >}}/sections/week-2-newtons-laws/5.2-worked-example-gravity-superposition) {{< br >}}{{< br >}} [Sliding Block]({{< baseurl >}}/sections/week-2-newtons-laws/ps.2.1-worked-example-sliding-block) {{< br >}}{{< br >}} [Pushing Stacked Blocks]({{< baseurl >}}/sections/week-2-newtons-laws/ps.2.2-worked-example-pushing-stacked-blocks) {{< br >}}{{< br >}} [Window Washer Problem]({{< baseurl >}}/sections/week-2-newtons-laws/ps.2.3-window-washer-problem) {{< br >}}{{< br >}}  |
| 5 | Gravity |
| 6 | Contact Forces |
| 7 | Tension and Springs |
| Deep Dive 1 | Friction |
| {{< td-colspan 4 >}}**Week 3: Circular Motion**{{< /td-colspan >}} ||||
| 8 | Circular Motion - Position and Velocity | [Problem Set 3 (PDF)]({{< baseurl >}}/sections/assignments/mit8_01f16_pset3) |  {{< br >}}{{< br >}} [Angular Position from Angular Acceleration]({{< baseurl >}}/sections/week-3-circular-motion/10.3-worked-example-angular-position-from-angular-acceleration) {{< br >}}{{< br >}} [Car on a Banked Turn]({{< baseurl >}}/sections/week-3-circular-motion/11.2-worked-example-car-on-a-banked-turn) {{< br >}}{{< br >}} [Orbital Circular Motion]({{< baseurl >}}/sections/week-3-circular-motion/PS.3.1-worked-example-orbital-circular-motion) {{< br >}}{{< br >}}  |
| 9 | Uniform Circular Motion |
| 10 | Circular Motion - Acceleration |
| 11 | Newton's 2nd Law and Circular Motion |
| {{< td-colspan 4 >}}**Week 4: Drag Forces, Constraints and Continuous Systems**{{< /td-colspan >}} ||||
| 12 | Pulleys and Constraints | [Problem Set 4 (PDF)]({{< baseurl >}}/sections/assignments/mit8_01f16_pset4) |  [2 Blocks and 2 Pulleys]({{< baseurl >}}/sections/week-4-drag-forces-constraints-and-continuous-systems/12.5-worked-example-2-blocks-and-2-pulleys) |
| 13 | Massive Rope |
| 14 | Resistive Forces |
| {{< td-colspan 4 >}}**Week 5: Momentum and Impulse**{{< /td-colspan >}} ||||
| 15 | Momentum and Impulse | [Problem Set 5 (PDF)]({{< baseurl >}}/sections/assignments/mit8_01f16_pset5) |  {{< br >}}{{< br >}} [Bouncing Ball]({{< baseurl >}}/sections/week-5-momentum-and-impulse/15.3-worked-example-bouncing-ball) {{< br >}}{{< br >}} [Center of Mass of 3 Objects]({{< baseurl >}}/sections/week-5-momentum-and-impulse/17.2-worked-example-center-of-mass-of-3-objects) {{< br >}}{{< br >}} [Center of Mass of a Uniform Rod]({{< baseurl >}}/sections/week-5-momentum-and-impulse/17.5-worked-example-center-of-mass-of-a-uniform-rod) {{< br >}}{{< br >}}  |
| 16 | Conservation of Momentum |
| 17 | Center of Mass and Motion of the Center of Mass |
| {{< td-colspan 4 >}}**Week 6: Continuous Mass Transfer**{{< /td-colspan >}} ||||
| 18 | Relative Velocity and Recoil | [Problem Set 6 (PDF)]({{< baseurl >}}/sections/assignments/mit8_01f16_pset6) |  {{< br >}}{{< br >}} [Rocket Sled Problem]({{< baseurl >}}/sections/week-6-continuous-mass-transfer/ps.6.1-rocket-sled-problem) {{< br >}}{{< br >}} [Snowplow Problem]({{< baseurl >}}/sections/week-6-continuous-mass-transfer/ps.6.2-snowplow-problem) {{< br >}}{{< br >}}  |
