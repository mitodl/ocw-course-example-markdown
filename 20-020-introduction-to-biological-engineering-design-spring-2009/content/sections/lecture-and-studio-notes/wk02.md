---
uid: 6b8945a5656858af227077538a80a7dd
...
{{< anchor "Top" >}}{{< /anchor >}}[< Previous week]({{< baseurl >}}/sections/lecture-and-studio-notes/wk01) | [Lecture and Studio Notes index]({{< baseurl >}}/sections/lecture-and-studio-notes) | [Next week >]({{< baseurl >}}/sections/lecture-and-studio-notes/wk03)
...
[Complete PDP3: Script and Storyboard]({{< baseurl >}}/sections/assignments/pdp3)
...
Begin today by reading the following script ([PDF]({{< baseurl >}}/sections/lecture-and-studio-notes/mit20_020s09_lec2_wk2_stus))

Next, we'll look at the [storyboards]({{< baseurl >}}/sections/lecture-and-studio-notes/wk2_storyboards) associated with this script.

Finally, we'll watch the [animation]({{< baseurl >}}/sections/biobuilder-animations/9.-the-igem-competition) that was generated from this script and posted to [BioBuilder](http://www.biobuilder.org).
...
[< Previous week]({{< baseurl >}}/sections/lecture-and-studio-notes/wk01) | [Lecture and Studio Notes index]({{< baseurl >}}/sections/lecture-and-studio-notes) | [Next week >]({{< baseurl >}}/sections/lecture-and-studio-notes/wk03)