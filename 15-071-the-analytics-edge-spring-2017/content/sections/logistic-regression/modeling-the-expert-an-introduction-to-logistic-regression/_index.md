---
uid: 3063320a41756b8a4fa9892f61b52c0d
...
menu:
  leftnav:
    identifier: 3063320a41756b8a4fa9892f61b52c0d
    name: '3.2 Modeling the Expert: An Introduction to Logistic Regression'
    weight: 790
    parent: c4464cf49ddb1a4bc78cfaa6f93b74de
---

*   [<Welcome to Unit 3]({{< baseurl >}}/sections/logistic-regression/welcome-to-unit-3)
...
*   [\>Video 2: Building the Dataset]({{< baseurl >}}/sections/logistic-regression/modeling-the-expert-an-introduction-to-logistic-regression/video-2-building-the-dataset)
...
The slides from all videos in this Lecture Sequence can be downloaded here: [An Introduction to Logistic Regression (PDF - 1.2MB)]({{< baseurl >}}/sections/lecture-and-recitation-notes/mit15_071s17_unit3_modelingexpert).

*   [BackWelcome to Unit 3]({{< baseurl >}}/sections/logistic-regression/welcome-to-unit-3)
*   [ContinueVideo 2: Building the Dataset]({{< baseurl >}}/sections/logistic-regression/modeling-the-expert-an-introduction-to-logistic-regression/video-2-building-the-dataset)