---
uid: f3a415ffeba9ca2d622f58bcb8aea03c
...
*   [<Quick Question]({{< baseurl >}}/sections/text-analytics/turning-tweets-into-knowledge-an-introduction-to-text-analytics/quick-question-395)
...
*   [\>Man vs. Machine: How IBM Built a Jeopardy Champion]({{< baseurl >}}/sections/text-analytics/man-vs-machine-how-ibm-built-a-jeopardy-champion)
...
*   [BackQuick Question]({{< baseurl >}}/sections/text-analytics/turning-tweets-into-knowledge-an-introduction-to-text-analytics/quick-question-395)
*   [ContinueMan vs. Machine: How IBM Built a Jeopardy Champion]({{< baseurl >}}/sections/text-analytics/man-vs-machine-how-ibm-built-a-jeopardy-champion)