---
uid: 55f5a296f8231477e8374b3f5b26d21f
...
*   [\>Quick Question]({{< baseurl >}}/sections/text-analytics/turning-tweets-into-knowledge-an-introduction-to-text-analytics/quick-question-362)
...
*   [BackTurning Tweets into Knowledge: An Introduction to Text Analytics]({{< baseurl >}}/sections/text-analytics/turning-tweets-into-knowledge-an-introduction-to-text-analytics)
*   [ContinueQuick Question]({{< baseurl >}}/sections/text-analytics/turning-tweets-into-knowledge-an-introduction-to-text-analytics/quick-question-362)