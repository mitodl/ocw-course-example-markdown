---
uid: 7a59278a134c5085244c381fc6090890
...
menu:
  leftnav:
    ...
    name: '8.3 Radiation Therapy: An Application of Linear Optimization '
    weight: 2820
...
The slides from all videos in this lecture can be downloaded here: [An Application of Linear Optimization (PDF - 1.8MB)]({{< baseurl >}}/sections/lecture-and-recitation-notes/mit15_071s17_unit8_radiationtherapy).
...
*   [BackVideo 8: The Edge of Revenue Management]({{< baseurl >}}/sections/linear-optimization/airline-revenue-management-an-introduction-to-linear-optimization/video-8-the-edge-of-revenue-management)
*   [ContinueQuick Question]({{< baseurl >}}/sections/linear-optimization/radiation-therapy-an-application-of-linear-optimization/quick-question-630)