...
Using read.csv(), load the dataset from [AnonymityPoll (CSV)](https://open-learning-course-data-production.s3.amazonaws.com/15-071-the-analytics-edge-spring-2017/fc53f44a4ec7c467b2f882a5636b0d3b_AnonymityPoll.csv) into a data frame called poll and summarize it with the summary() and str() functions.
