---
uid: 4495fb4839343c3323b22ef2104af559
...
menu:
  leftnav:
    identifier: 4495fb4839343c3323b22ef2104af559
    name: '2.2 The Statistical Sommelier: An Introduction to Linear Regression'
    weight: 410
    parent: c846ced6fc6d3bc964e047324e251a98
---

*   [<Welcome to Unit 2]({{< baseurl >}}/sections/linear-regression/welcome-to-unit-2)
...
*   [\>Quick Question]({{< baseurl >}}/sections/linear-regression/the-statistical-sommelier-an-introduction-to-linear-regression/quick-question-46)
...
The slides from all videos in this Lecture Sequence can be downloaded here: [Introduction to Linear Regression (PDF - 1.3MB)]({{< baseurl >}}/sections/lecture-and-recitation-notes/mit15_071s17_unit2_wineregression).

*   [BackWelcome to Unit 2]({{< baseurl >}}/sections/linear-regression/welcome-to-unit-2)
*   [ContinueQuick Question]({{< baseurl >}}/sections/linear-regression/the-statistical-sommelier-an-introduction-to-linear-regression/quick-question-46)