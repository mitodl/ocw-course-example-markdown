---
uid: c46fe11ed02304f575354315faa42e52
...
3.  Basic Idea
    *   Keep a log of all changes and whether a transaction commits or aborts.
        ...
        *   ABORT records specify that transaction aborted.
            *   Not always needed.
    *   (See [Lecture 16 slides (PDF)]({{< baseurl >}}/sections/week-9/mit6_033s18lec16) for the log for this example.)
...
4.  How to Use a Log for Transactions
    ...
    *   On recover: Nothing.
    *   (see [Lecture 16 slides (PDF)]({{< baseurl >}}/sections/week-9/mit6_033s18lec16) for code.)
